...
void IiTInterface::OnTweenLoopNative(AiTweenEvent* eventOperator, AActor* actorTweening /*= nullptr*/, USceneComponent* componentTweening /*= nullptr*/, UWidget* widgetTweening /*= nullptr*/, FName tweenName /*= ""*/, int32 numberOfLoopSections /*= 0*/, ELoopType::ItweenLoopType loopType /*= once*/, bool playingBackward /*= false*/)
{
	UiTween::Print("Interface message sending...");
}
