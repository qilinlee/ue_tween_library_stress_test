...
public:
	...
	UPROPERTY(VisibleAnywhere, BlueprintReadWrite, Category = "Generic Properties")
		TEnumAsByte<ECoordinateSpace::ItweenCoordinateSpace> coordinateSpace = ECoordinateSpace::ItweenCoordinateSpace::world;
	...
	UPROPERTY(VisibleAnywhere, BlueprintReadWrite, Category = "Generic Properties")
		TEnumAsByte<EVectorConstraints::ItweenVectorConstraints> vectorConstraints = EVectorConstraints::ItweenVectorConstraints::none;

	UPROPERTY(VisibleAnywhere, BlueprintReadWrite, Category = "Generic Properties")
		TEnumAsByte<EVector2DConstraints::ItweenVector2DConstraints> vector2DConstraints = EVector2DConstraints::ItweenVector2DConstraints::none;

	UPROPERTY(VisibleAnywhere, BlueprintReadWrite, Category = "Generic Properties")
		TEnumAsByte<ERotatorConstraints::ItweenRotatorConstraints> rotatorConstraints = ERotatorConstraints::ItweenRotatorConstraints::none;

	UPROPERTY(VisibleAnywhere, BlueprintReadWrite, Category = "Generic Properties")
		TEnumAsByte<EDelayType::ItweenDelayType> delayType = EDelayType::ItweenDelayType::first;

	UPROPERTY(VisibleAnywhere, BlueprintReadWrite, Category = "Generic Properties")
		TEnumAsByte<ETickType::ItweenTickType> tickType = ETickType::ItweenTickType::seconds;

	UPROPERTY(VisibleAnywhere, BlueprintReadWrite, Category = "Generic Properties")
		TEnumAsByte<EEaseType::ItweenEaseType> easeType = EEaseType::ItweenEaseType::linear;
	...
	UPROPERTY(VisibleAnywhere, BlueprintReadWrite, Category = "Generic Properties")
		TEnumAsByte<ELoopType::ItweenLoopType> loopType = ELoopType::ItweenLoopType::once;

	UPROPERTY(VisibleAnywhere, BlueprintReadWrite, Category = "Move Properties")
		TEnumAsByte<ELookType::ItweenLookType> orientation;
	...
	UPROPERTY(VisibleAnywhere, BlueprintReadWrite, Category = "Generic Properties")
		TEnumAsByte<EEventType::ItweenEventType> eventType;
	...
	UPROPERTY(EditAnywhere, BlueprintReadWrite, meta = (DisplayName = "Data Type Values"), Category = "Data Type Tween Values")
	...
	//Transform Offsets
	UPROPERTY(VisibleAnywhere, BlueprintReadWrite, Category = "Transform Offset")
	...
	UPROPERTY(VisibleAnywhere, BlueprintReadWrite, Category = "Transform Offset")
		FVector scale3DOffset = FVector::ZeroVector;

	UPROPERTY(VisibleAnywhere, BlueprintReadWrite, Category = "UMG Render Transform Offset")
		FVector2D translationOffset = FVector2D::ZeroVector;

	UPROPERTY(VisibleAnywhere, BlueprintReadWrite, Category = "UMG Render Transform Offset")
		FVector2D shearOffset = FVector2D::ZeroVector;
	...
	UFUNCTION()
		FString GetEventTypeEnumAsFString(EEventType::ItweenEventType enumValue);

	UFUNCTION()
		bool IsEventDataType();

	UFUNCTION()
		void RunInterface(UObject* target, ETweenInterfaceType::ItweenInterfaceType type);
